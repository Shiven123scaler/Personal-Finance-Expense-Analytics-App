      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="lg:col-span-1">
          {Object.keys(analytics.byCategory).length > 0 ? (
            <SpendingPieChart data={analytics.byCategory} className="h-full flex flex-col" />
          ) : (
            <div className="bg-white dark:bg-gray-800 transition-colors duration-200 rounded-xl p-5 border border-gray-100 dark:border-gray-800 h-full flex flex-col">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4 shrink-0">Spending by Category</h3>
        ...
        {/* Recent Transactions */}
        <div className="lg:col-span-1 border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800 transition-colors duration-200 rounded-xl p-5 h-[400px] flex flex-col">
          <div className="flex items-center justify-between mb-4 shrink-0">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Recent Transactions</h3>
            <button
              onClick={() => navigate('/transactions')}
              className="text-xs text-[#185FA5] hover:underline cursor-pointer"
            >
              View all
            </button>
          </div>
        ...
        <div className="lg:col-span-1 h-[400px]">
          <NewsFeed className="h-full flex flex-col" />
        </div>
      </div>
